...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="img/tunerlogo.png" />
  <!-- Author Meta -->
          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="img/guitar.jpg" alt="">
              ...
              <h4 class="text-white mb-20 mt-30">Learn guitar Course from our Legendary Tutor</h4>
              <p class="text-white mb-20">
              Designed for beginners and intermediate players alike, our course is led by a seasoned and revered
                 guitar virtuoso who brings decades of experience to the table.
              </p>
            </div>
            ...
            <div class="single-video">
              ...
              <h4 class="text-white mb-20 mt-30">Learn Keybord Course from our Legendary Tutor</h4>
              <p class="text-white mb-20">
              Unleash your musical potential as you embark on a transformative journey guided by a distinguished 
                keyboard virtuoso, bringing a wealth of experience and artistry to your learning experience
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="feature-inner row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-blog-post">
            <img src="img/Flute.jpg" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
            ...
            <div class="text">
              <h4 class="text-white">Flute Carnival</h4>
              <div>
                <p>
                Embark on a melodic journey with the flute, an enchanting wind instrument 
                  that breathes life into soulful tunes
                </p>
              </div>
        ...
        <div class="col-lg-4 col-md-6 mt--160">
          <div class="single-blog-post">
            <img src="img/carnival.jpg" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
            ...
            <div class="text">
              <h4 class="text-white">musical Carnival</h4>
              <div>
                <p>
                "Immerse yourself in a vibrant symphony of sounds and rhythms at the Music Carnival, 
                  where diverse genres and performers come together.
                </p>
              </div>
              <a href="blog-single1.html" class="primary-btn">
                View Details
                <i class="fa fa-long-arrow-right"></i>
              </a>
            </div>
        ...
        <div class="col-lg-4 col-md-6 mt--260">
          <div class="single-blog-post">
            <img src="img/concert.jpg" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
            ...
            <div class="text">
              <h4 class="text-white">Consert</h4>
              <div>
                <p>
                Experience the magic of live music as concerts transform into memories,
                   uniting audiences in the  heartbeat of shared melodies
                </p>
              </div>
              <a href="blog-single2.html" class="primary-btn">
                View Details
                <i class="fa fa-long-arrow-right"></i>
              </a>
            </div>
