...
function loadMusic(indexNumb){
   mainVideo.src = `../Admin/template/coursevideo/${allVideos[indexNumb-1].src}.mp4`;
...
for(let i = 0; i < allVideos.length; i++){
   let liTag = `<li li-index="${i + 1}">
      ...
      <video class="${allVideos[i].id}" src="../Admin/template/coursevideo/${allVideos[i].src}.mp4" style="display: none;" title="${allVideos[i].name}"></video>
